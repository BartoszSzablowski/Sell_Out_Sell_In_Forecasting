...
class FeatureEngineeringTransformer_Scenario2(BaseEstimator, TransformerMixin):
    def __init__(self, promo_variables=['numeric_distribution_selling_promotion_hyperparmarkets', 'type_promo_1', 'type_promo_2']):
        self.promo_variables = promo_variables
